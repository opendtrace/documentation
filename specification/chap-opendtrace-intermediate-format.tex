...
within the \function{dtrace_dif_emulate} function, which has, as its
first argument, a pointer to a DIF Object or
...
along with various implementation details.  
...
DTrace provides an extensive set of subroutines for use by D programs.
