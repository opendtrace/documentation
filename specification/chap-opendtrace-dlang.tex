...
<Expression> ::=  <Expression> <bin\_operator> <Expression>
             ...
             \alt [ ( `this->' | `self->' ) ] <Identifier> [ `[' ( <Integer> | <Identifier> ) \{ ( <Integer> | <Identifier> ) \} `]' ] ;

<AggExpression> ::=  `@' [ <Identifier> ] [ `[' ( <Integer> | <Identifier> ) [ `,' \{ ( <Integer> | <Identifier> ) \} ] ] `=' <AggFunc> ;
...
<Statement> ::= ( <Expression> | <AggExpression> | <Declaration> ) `;' ;
\end{grammar}
...
inside of the \function{dtrace_probe()} function, but it does not
